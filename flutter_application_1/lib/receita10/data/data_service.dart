...
class DataService {
  ...
  void ordenarEstadoAtual(String propriedade, bool ascending) {
    ...
    emitirEstadoOrdenado(objetosOrdenados, propriedade, type.properties.indexOf(propriedade), ascending);
  }
  ...
  void emitirEstadoOrdenado(List objetosOrdenados, String propriedade, int column, bool ascending) {
